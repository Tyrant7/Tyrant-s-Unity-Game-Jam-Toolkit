...
/// <summary>
/// A class to handle crossfading between soundtracks.
/// </summary>
public class SoundtrackManager : MonoBehaviour
{
    ...
    /// Plays a soundtrack.
    /// </summary>
    /// <param name="newSoundtrack">The soundtrack to play.</param>
    /// <param name="crossfade">Should this new soundtrack crossfade?</param>
    /// <param name="keepPlaybackTime">Should this new soundtrack keep the playback time of the current soundtrack?</param>
